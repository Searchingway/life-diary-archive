...
当前这一版已经从“纯日记”扩到“日记 + 足迹 + 读书笔记 + 轻计划 + 教训与反思”。桌面端继续优先迭代新功能，Android 手机版慢一个版本同步。核心目标仍然是本地优先、长期可保存、结构清晰、后续方便继续扩。
...
- 主窗口五页签：`日记` / `足迹` / `读书` / `轻计划` / `教训与反思`
- 日记列表、地点足迹列表、书单列表、轻计划列表、反思记录列表
- 新建、查看、编辑、保存、删除
