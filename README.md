...
当前这一版已经从“纯日记”扩到“总览 + 日记 + 足迹 + 读书笔记 + 轻计划 + 教训与反思”。桌面端继续优先迭代新功能，Android 手机版慢一个版本同步。核心目标仍然是本地优先、长期可保存、结构清晰、后续方便继续扩。
...
- 日记、足迹、读书笔记、轻计划、教训与反思五个可编辑页支持桌面端自动保存
...
- 五个可编辑页支持自动保存，状态栏会提示已保存、有未保存修改、自动保存中、已自动保存或自动保存失败
- 日记 / 足迹 / 读书均可导出压缩包交换包
- 日记页显示最近 18 周热力统计图
...
- 主窗口上方是六个页签：`总览`、`日记`、`足迹`、`读书`、`轻计划`、`教训与反思`
...
- 自动保存测试，覆盖日记、轻计划、教训与反思、页签切换、图片备注、恢复已保存内容和空白草稿
