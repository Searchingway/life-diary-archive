# 人生档案 Diary - Desktop 3.0 双端闭环与深度整理版

当前桌面端升级到 Desktop 3.0「双端闭环与深度整理版」。核心分工是：手机版负责每天快速记录，电脑版负责导入、整理、分析、复盘和归档。所有数据仍然本地优先，保存到 `data/Diary/`，新增模块继续兼容原有目录结构，不做云同步、账号登录或 AI 自动分析。
...
- 总览页升级为全模块时间线，接入日记、足迹、作品感悟、轻计划、教训反思、自我分析、轻思考、轻资源、自我观察
...
Desktop 3.0 的目标是让电脑版成为手机版每日记录数据的深度整理台：
...
- 作品类型至少支持：书籍、电影、纪录片、动漫、游戏、文章、音乐、课程、视频、展览、其他。
...
- 主窗口十一页签：`总览` / `日记` / `足迹` / `作品感悟` / `轻计划` / `教训与反思` / `自我分析` / `轻思考` / `轻资源` / `自我观察` / `数据管理`
...
- 总览页可刷新并展示 8 个基础统计数字、全模块数量和最近 30 条全模块时间线
- 总览页可手动备份数据，也可从合法 zip 备份包恢复数据；数据管理页提供手机版 ZIP 导入、电脑版 ZIP 导出和健康检查
- 日记、足迹、轻计划、教训反思、自我分析、作品感悟、轻思考、轻资源、自我观察等可编辑页支持自动保存，状态栏会提示已保存、有未保存修改、自动保存中、已自动保存或自动保存失败
- 日记页显示最近 18 周热力统计图
...
- 主窗口上方是十一个页签：`总览`、`日记`、`足迹`、`作品感悟`、`轻计划`、`教训与反思`、`自我分析`、`轻思考`、`轻资源`、`自我观察`、`数据管理`
- 总览页顶部是本月 / 今年的日记和计划统计，中间显示全模块数量和最近更新时间，下方是最近 30 条全模块时间线
